## v2ray-heroku
[![](https://www.herokucdn.com/deploy/button.png)](https://heroku.com/deploy?template=https://github.com/treeandtree21/Heroku-v2ray.git)
...
![image](https://cdn.jsdelivr.net/gh/treeandtree21/Heroku-v2ray/doc/1.png)

请求`/speedtest/`，html5-speedtest测速页面

![image](https://cdn.jsdelivr.net/gh/treeandtree21/Heroku-v2ray/doc/2.png)

请求`/test/`，文件下载速度测试

![image](https://cdn.jsdelivr.net/gh/treeandtree21/Heroku-v2ray/doc/3.png)
